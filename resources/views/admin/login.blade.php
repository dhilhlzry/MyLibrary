            ...
            <div class="signin-signup">
                <form action="" class="sign-in-form" method="POST">
                    ...
                    <div class="input-field">
                        ...
                        <i id="pass-statuss" class="bx bxs-show" aria-hidden="true" onclick="viewpasswordd()"
                            style="font-size: 21px ;float: right; color: grey; margin-top: -55px; margin-left: 325px;"></i>
                    </div>
