            ...
            <section class="modal-container-body rtf">
                <form action="simpan_laporan" method="post" enctype="multipart/form-data">
                    ...
                    <div class="des">
                        ...
                        <div class="">
                            <input type="date" class="des1" placeholder="Masukan Tanggal" value="" name="daritanggal">
                        </div>
                    </div>
                    <br>
                    <div class="des">
                        ...
                        <div class="">
                            <input type="date" class="des1" placeholder="Masukan Tanggal" value="" name="sampaitanggal">
                        </div>
                    </div>
                    <br>
                    <div class="des">
